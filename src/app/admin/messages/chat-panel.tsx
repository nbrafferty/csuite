      ...
      >
        ...
        >
          ...
          <div style={{ minWidth: 0 }}>
            <div style={{ fontSize: 15, fontWeight: 700 }}>{thread.subject}</div>
            <div
              style={{
                display: "flex",
                alignItems: "center",
                ...
                >
                  <span
                    style={{
                      fontSize: 12,
                      fontWeight: 600,
                      color: isInternal ? COLORS.yellow : COLORS.textPrimary,
                    }}
                  >
                    {msg.sender}
                  </span>
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                fontWeight: 600,
                cursor:
                  !messageText.trim() || isSending ? "not-allowed" : "pointer",

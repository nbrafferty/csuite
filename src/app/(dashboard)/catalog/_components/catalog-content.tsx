...
import { Search, LayoutGrid, LayoutList, Check, PartyPopper } from "lucide-react";
...
const CATEGORY_NAV = [
  ...
  { label: "Printing", id: "COMMERCIAL_PRINTING" },
  { label: "Signage", id: "SIGNAGE" },
  { label: "Promo", id: "PROMO_ITEM" },
];
...
export function CatalogContent() {
  ...
  // Fetch products using the current catalog.list tRPC endpoint
  const { data: catalogData } = trpc.catalog.list.useQuery(
    {
      contentType: activeCategory ? (activeCategory as any) : undefined,
  ...
  // Client-side search filtering (server already filters by contentType)
